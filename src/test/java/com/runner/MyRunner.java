...
@CucumberOptions(features = "src/test/resources/com/features/", glue = { "com.stepdefinations",
		"com.hooks" }, plugin = { "pretty", "io.qameta.allure.cucumber7jvm.AllureCucumber7Jvm",
				"html:target/cucumber-reports" }, tags = "@productDetail3", publish = false, monochrome = false, dryRun = false)
